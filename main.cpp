...
int main(void)
{
	...
	st7735.Clear(0,0,162,162,ST7735_COLOR_WHITE);
	...
	sprintf(c,"%d.%d MHz", STATION[ i ]/10, STATION[ i ]%10);
	
	st7735.WriteString(c,5,5,Font_Arial_16x16,ST7735_COLOR_BLACK);
    ...
    while(1)
	{
 		if (!(PINB & (1 << PB0)))
 		{
			...
			st7735.Clear(0,0,100,30,ST7735_COLOR_WHITE);
			st7735.WriteString(c,5,5,Font_Arial_16x16,ST7735_COLOR_BLACK);
